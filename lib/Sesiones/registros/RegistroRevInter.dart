...
//Revisor Interno page
class RevInterno extends StatefulWidget {
  RevInterno({super.key});

  @override
  _RevInternoState createState() => _RevInternoState();
}

class _RevInternoState extends State<RevInterno> {
  ...
  void registerUserIn(BuildContext context) async {
    try {
      ...
      await FirebaseFirestore.instance
        ...
        'CorreoPersonal': personalEmailController.text,
